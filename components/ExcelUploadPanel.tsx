      ...
      <Card>
        ...
        {result && (
          <div style={{ marginTop: 20, borderTop: "1px solid #eee", paddingTop: 16 }}>
            ...
            {result.supportRequestsLogged > 0 && (
              <p style={{ fontSize: 13, color: "#6E6E6E" }}>
                {result.supportRequestsLogged} replacement/support request{result.supportRequestsLogged === 1 ? "" : "s"} logged in POS Requests for review.
              </p>
            )}
          </div>
        )}
