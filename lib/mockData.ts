...
const hsQuestionSeed: QSeed[] = [
  ...
  { qnum: 15, section: "Welfare Facilities", order: 15, text: "Report issue here", answerType: "Short answer", required: false },
  ...
  { qnum: 22, section: "Hazards & Housekeeping Standards", order: 22, text: "Upon your walk around (include any outside and entrance areas), did you encounter any hazards to customers or employees which you were not able to immediately rectify? (e.g. trailing cables, changes in floor levels not marked, damages/defects likely to cause injury, equipment condition, unsecured furniture, signage)", answerType: "Single choice", options: "No; I have unsecured furniture in the showroom (please put suitable temporary signage on it); Report a different issue", required: true },
  { qnum: 26, section: "Hazards & Housekeeping Standards", order: 22.5, text: "Report issue here", answerType: "Short answer" },
  ...
  { qnum: 66, section: "Fire Warden Checklist", order: 31.5, text: "Is the Fire Warden poster displayed, with your Fire Warden's name on it?", answerType: "Single choice", options: "Yes; No - I need a poster", required: true },
  { qnum: 33, section: "Fire Warden Checklist", order: 33, text: "Have there been any fires, incidents or need to use extinguishers at your site?", answerType: "Single choice", options: "Yes, and it is logged in the log book; No", required: false },
  { qnum: 34, section: "Fire Warden Checklist", order: 34, text: "Do you require any update to the fire extinguishers after use?", answerType: "Short answer", required: false },
  ...
  // Added 25 Sep 2026 so PREVIEW_MODE covers the new H&S checks (lib/hsIssueChecks.ts) - mirrors the live questions.
  { qnum: 37, section: "Fire Warden Checklist", order: 37, text: "Emergency Escape Lighting Tests - has this been completed this month?", answerType: "Single choice", options: "Yes; No - I don't have any illuminated lighting; I'll speak with Gavin Carey/Julia Kerr who know how to do this and learn from him for next month", required: true },
  { qnum: 38, section: "Fire Warden Checklist", order: 38, text: "When do your fire extinguishers require a service?", answerType: "Date", required: true },
  { qnum: 67, section: "Fire Warden Checklist", order: 38.5, text: "When is your next fire drill due?", answerType: "Date", required: true },
  ...
  { qnum: 46, section: "First Aid", order: 46, text: "Please tick the following if they have been satisfied (any issues can be reported in the next question)", answerType: "Multiple choice (checkboxes)", options: "The first aid kit has been checked and is suitably stocked, easy to find and has signage nearby; There is an accident report book on site, stored in a secure place due to GDPR (kept for up to 3 years); There is a poster with the First Aider or Appointed Person's name displayed, and this person is still qualified and working for the business; Any separate items from the kit, such as eye wash or burn items, have also been checked and are in date", required: true },
  { qnum: 47, section: "First Aid", order: 47, text: "Our first aid kit expires on...", answerType: "Date", required: true },
  ...
  { qnum: 63, section: "And finally...", order: 63, text: "I need to request training for...", answerType: "Single choice", options: "Not required; First Aider on site (for larger sites); First aid appointed person training (suitable for most showrooms); Fire Warden" },
  { qnum: 64, section: "And finally...", order: 64, text: "Who is the training for?", answerType: "Short answer", options: "n/a if not required" },
